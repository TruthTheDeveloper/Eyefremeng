...
const Modal = () => {
    ...
    return(
        <div className="fixed  top-0 left-0 h-screen w-full z-40 hidden" style={{backgroundColor:'rgba(0, 0, 0, 0.774)'}}>
            <div className="bg-white mt-44 w-96 mx-auto border-2  h-56 rounded-md">
