...
const OrderedProductDetail = () => {
  ...
  const getOrderDetail = async () => {
    const data = await OrderServices.getOrder(
  ...
  return (
    <>
      ...
      <div className="m-10">
        <h1 className="text-indigo-500 text-center my-4 text-2xl">
          Payment Detail
        </h1>
        <ul>
          <li className="border-2 border p-2 w-full ">
          ...
          <li className="border-2 border p-2 w-full ">
            payment Type:{detail.paymentMethod}
          </li>
          <li className="border-2 border p-2 w-full ">
          ...
          <li className="border-2 border p-2 w-full ">
            withinLagos:{detail.withinLagos}
          </li>
          <li className="border-2 border p-2 w-full ">
