...
const RightSideDrawer = ({ open, close }) => {
  ...
  return (
    <>
      {open ? (
        <section
          className="fixed top-0 left-0 h-screen  w-full z-40 rsd_anime  lg:hidden"
        ...
        >
          <div className=" shadow-lg rounded-lg h-full flex z-50">
            <section className="bg-indigo-800 text-white basis-1/6   lg:hidden mt-14 ">
              <FontAwesomeIcon
                icon={faClose}
                className="ml-48 mb-8  text-white text-2xl mx-3 mt-3"
                onClick={close}
              />
              <div
              ...
              <div className="flex py-3 text-center  cursor-pointer mx-3">
                <div
                  className="flex p-3 w-full hover:bg-white hover:text-indigo-800 "
                  onClick={orderNav}
                >
                  <FontAwesomeIcon
                    icon={faBagShopping}
                  ...
                  <div className="bg-red-400 px-2 mx-2 text-lg rounded-full text-white">
                    3
                  </div>
                </div>
              </div>
