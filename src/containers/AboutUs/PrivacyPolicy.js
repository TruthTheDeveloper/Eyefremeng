  ...
  return (
    <section className="py-24 text-indigo-800 font-semibold md:text-lg">
      <div className="bg-indigo-800 text-center py-12">
        <h1 className="text-white text-xl font-semibold">PRIVACY POLICY</h1>
      </div>
      <div className="mx-6 md:mx-16 lg:mx-40">
        ...
        <div>
          ...
          <p>Eyeframeng uses the collected data for various purposes:</p>
          <ul className="mx-6 my-4 list-disc">
        ...
        <div>
          ...
          <p>
            Eyeframeng will retain your Personal Data only for as long as is
          ...
          <p>
            Eyeframeng will also retain Usage Data for internal analysis
