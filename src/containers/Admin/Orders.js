  ...
  return (
    <section className="w-full overflow-x-auto  h-[35rem]   overflow-y-auto">
      ...
      <div className="grid grid-cols-6 justify-center my-6 text-center shadow-md border mx-4 rounded-lg w-[68rem]">
        <div className=" font-semibold p-2">Full Name</div>
        <div className=" font-semibold  p-2">Purchase On</div>
        <div className=" font-semibold  p-2">Amount</div>
        <div className=" font-semibold  p-2">phonenumber</div>
        <div className=" font-semibold p-2">Payment Type</div>
        <div className=" font-semibold p-2">Status</div>
      </div>
      {allOrder.length === 0 && (
