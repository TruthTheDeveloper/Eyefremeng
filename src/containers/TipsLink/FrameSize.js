  ...
  return (
    <section className="py-24 font-semibold text-center">
      ...
      <div className="my-4 text-2xl md:mx-12">
        <h1>
          At Eyeframeng we offer multiple sizes so that you can find the right
          frame for your face
        </h1>
      </div>
      ...
      <div className="my-8  md:mx-12">
        ...
        <p className="text-xl">
          Most of our customers are comfortable in this range. If you are unsure
          about your size, choose this.
        </p>
      </div>
      <div className="my-8  md:mx-12">
        <h1 className="text-orange-500 text-2xl font-semibold">LARGE</h1>
        <p className="text-xl">
          For those who have a wide forehead and narrow chin.
        </p>
      </div>
      ...
      <p className="text-xl md:mx-12 lg:mx-24 xl:mx-44">
        "To find out your frame size is by using a pair of your current glasses.
        The frame sizes are usually printed on the inside of the temple. If the
        glasses were previously fitted by an optician or the glasses sit well on
        your face then you can use the measurements on the temple to purchase
