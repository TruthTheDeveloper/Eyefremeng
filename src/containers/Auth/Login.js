      ...
      <div className="py-24 mx-6 xl:mx-64">
        ...
        <div>
          ...
          {passwordValidationError && (
            <p className="text-red-500 text-sm">Please input password field</p>
          )}
        </div>
        <div className="my-4 ">
          <button
          ...
          <button
            className="py-3 py-2 px-6 mx-3 border rounded-md border-indigo-800 my-3 sm:my-0 text-indigo-800"
            onClick={navigateToDashboard}
          >
            {spinner ? (
              <div className="py-1">
                <TailSpin color="#3730A3" height={20} width={40} />
              </div>
            ) : (
              "Login"
            )}
          ...
          <button
            className="text-sm text-indigo-800 font-semibold block md:inline"
