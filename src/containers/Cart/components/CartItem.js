  ...
  return (
    <div className="mx-4 md:mx-12 lg:grid grid-cols-3">
      ...
      <div className="my-12 lg:h-[28rem] lg:my-0 border p-3 xl:mx-12">
        <div className="">
          <input
            className="w-full h-10 p-2 border-black border placeholder:text-slate-600 rounded-sm"
        ...
        <p className="border py-3 text-right font-semibold text-lg pr-2">
          Total
        </p>
        ...
        <button
          className="border py-3 bg-slate-800 w-full text-orange-500"
          onClick={navigateToCheckout}
        >
          <p>Proceed to Checkout</p>
        </button>
        <button
          className="border py-3 my-2 px-3 border-slate-500 rounded-sm flex ml-auto"
