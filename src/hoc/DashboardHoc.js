...
const DashboardHoc = ({ children }) => {
  ...
  return (
    <section className="py-24 ">
      <h1 className="text-center md:text-2xl text-xl text-indigo-800">
      ...
      <div className="bg-white shadow-lg rounded-lg xl:mx-24 flex z-50">
        <section className="bg-indigo-800 text-white basis-1/6 hidden lg:block">
          <div
            className="flex py-3  text-center  cursor-pointer mx-3"
            onClick={dashboardNav}
          >
            <div
              className={
                active.dashboard
                  ? "bg-white text-indigo-800 flex p-3 w-full "
                  : " hover:text-indigo-800 text-white flex hover:bg-white p-3 w-full"
              }
            >
          ...
          <div className="flex py-3 text-center  cursor-pointer mx-3">
            <div
              className={
                active.orders
                  ? "flex p-3 w-full bg-white text-indigo-800"
                  : "flex p-3 w-full hover:bg-white hover:text-indigo-800"
              }
              onClick={orderNav}
            >
          ...
          <div className="flex py-3   cursor-pointer mx-3">
            <div
              ...
              onClick={subscriberNav}
            >
              <FontAwesomeIcon
                icon={faMessage}
                className="mx-4 text-2xl hover:bg-white hover:text-indigo-800"
              />
              <h1>Subscribers</h1>
            </div>
          </div>
